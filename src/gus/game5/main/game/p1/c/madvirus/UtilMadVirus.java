...
public class UtilMadVirus {
	...
	public static int[][] generateForLevel(int level) {
		switch(level) {
			case 1:return UtilArrayInt.randomIntArray2(10, 17, new int[][] { //170 = 12+39+34+42+43
				{12,0}, //12: 0 (black)
				{39,1}, //39: 1 (jaune)
				{34,2}, //34: 2 (vert)
				{42,3}, //42: 3 (rouge)
			...
			case 2:return UtilArrayInt.randomIntArray2(11, 20, new int[][] { //220 = 14+44+39+36+45+42
				{14,0}, //14: 0 (black)
				{44,1}, //44: 1 (jaune)
				{39,2}, //39: 2 (vert)
				{36,3}, //36: 3 (rouge)
			...
			case 3:return UtilArrayInt.randomIntArray2(13, 23, new int[][] { //299 = 24+49+44+40+52+47+43
				{24,0}, //14: 0 (black)
				{49,1}, //44: 1 (jaune)
				{44,2}, //39: 2 (vert)
				{40,3}, //36: 3 (rouge)
			...
			case 4:return UtilArrayInt.randomIntArray2(14, 24, new int[][] { //336 = 29+54+49+45+60+52+47
				{30,0}, //14: 0 (black)
				{54,1}, //44: 1 (jaune)
				{49,2}, //39: 2 (vert)
				{45,3}, //36: 3 (rouge)
