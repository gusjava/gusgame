...
//		if(game.getCount() < game.getLastPlayCount() + 50) return false;
		...
		if(play==null) throw new TechnicalException("PlayerRagusMinmax found no play");
		...
		if(newData==null) throw new TechnicalException("PlayerRagusMinmax found invalid play: "+UtilArrayInt.toString(play));
