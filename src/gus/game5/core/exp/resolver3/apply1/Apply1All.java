...
public class Apply1All extends Apply1 {
	...
	public Object apply(TokenSequence sequence, Context context, Object data, TokenList param) throws ExpException {
		...
		if(data instanceof List) {
			...
			for(Object elem : list) if(!filter.filter(elem)) return false;
			return true;
		}
		
		throw new ExpResolveException(sequence, "Could not apply Apply1All for data type: "+data.getClass().getName());
	}
